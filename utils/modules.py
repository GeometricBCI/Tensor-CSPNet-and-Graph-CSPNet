...
Date       : 1st, Sep., 2022
---------------------------------------------------------------------------------------------------------------------
Discription: This file builds basic modules including the BiMap layer, the graph BiMap layer, the Riemannian 
...
2. geoopt.ManifoldParameter(th.empty(self._h, self._ni, self._no), manifold = ..)
    ...
    Normalization are on Stiefel manifolds and SPD manifolds. The backpropogations are from the following ways:
        ...
        BiMap/Graph BiMap <------ “geoopt” for StiefelParameter; 

        BatchNormSPD      <------ ”geoopt“ for ManifoldParameter; 
...
'''
This class is modified from adavoudi/spdnet: https://github.com/adavoudi/spdnet
The aim of this class is to increase the dimension of weights W, e.g., from (3, 3) 
to (5, 5) with the expanding dimension being the identity matrix I_2.
'''
