...
Date       : 1st, Sep., 2022
---------------------------------------------------------------------------------------------------------------------
Description: This is a python implementation of Tensor-CSPNet and Graph-CSPNet. The hyperparameters in the model are 
...
be optimized further. 
            ...
            self.dimes: This is for the shape dimension (in and out) in each BiMap layer, for example, [20, 30, 30, 20] 
            means the first BiMap layer has the input dimension 20 and output dimension 30, and the second BiMap layer 
            has the input dimension 30 and output dimension 20. 

            self.kernel_size: This number should be equal to the number of temporal segments. 

            self.tcn_channels: Better to set a big number. For example, if kernel_size = 1, the tcn_channel = 16.
