...
Date       : 1st, Sep., 2022
---------------------------------------------------------------------------------------------------------------------
Discription: The utility functions in this file provide the forward function of the ReEig layer, the LogEig layer, 
...
All the fuctions and classes come from GitHub, 

mainly from https://gitlab.lip6.fr/schwander/torchspdnet 
