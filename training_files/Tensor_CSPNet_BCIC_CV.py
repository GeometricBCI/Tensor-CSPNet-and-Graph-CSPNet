...
Date       : 1st, Sep., 2022
---------------------------------------------------------------------------------------------------------------------
Discription: Trainning file of Tensor-CSPNet for the cross-validation scenario on BCIC-IV-2a. 
#######################################################################################################################
'''
...
if __name__ == '__main__':
    ...
    for sub in range(args.start_No, args.end_No + 1):
        ...
        for kf_iter in range(0, 10):
            ...
            #For the cross-validation scenario, I prefer to ban the validataion option to boom up training trials. 
            acc, loss = main(
                args       = args, 
                train      = x_train_stack, 
                test       = x_test_stack, 
